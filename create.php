...
(nom, prenom, mail, adresse, telephone, date_naissance, genre, langues,
niveau_etude, interets, photo, document)
VALUES (:nom, :prenom, :mail, :adresse, :telephone, :date_naissance,
:genre, :langues, :niveau_etude, :interets, :photo, :document)";
...
<a name="liste" class=" my-5 px-4 py-2 mr-5 bg-green-600 text-white rounded hover:bggreen-700"
href="index.php">Liste
des étudiants +++2
</a>
